...
public class StoryAdapter4 extends BaseAdapter {
    private List<Article> list;
    private Context context;
    private int itemId;

    public StoryAdapter4 (List<Article> list, Context context, int itemId){
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //img1从数据库获取
//        viewHolder.img1.setImageBitmap(BitmapFactory.decodeResource(context.getResources(),R.drawable.s4));
