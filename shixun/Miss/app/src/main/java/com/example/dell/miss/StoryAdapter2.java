...
public class StoryAdapter2 extends BaseAdapter {
    private List<Article> list;
    private Context context;
    private int itemId;

    public StoryAdapter2 (List<Article> list, Context context, int itemId){
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //img1从数据库获取
//        viewHolder.img1.setImageBitmap(BitmapFactory.decodeResource(context.getResources(),R.drawable.s2));
        Glide.with(context).load(Constant.URL+"images/"+list.get(position).getPicture()).into(viewHolder.img1);
