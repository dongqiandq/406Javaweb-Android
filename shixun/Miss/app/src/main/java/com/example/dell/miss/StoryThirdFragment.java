...
public class StoryThirdFragment extends Fragment {
    private List<Article> list = new ArrayList<>();
    private ListView listView;
    private StoryAdapter3 adapter;

    private Integer tag=3;
    private View v;

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.activity_story_third,container,false);
        this.v=view;
...
//        findViews(view);
    ...
    private void findViews(View view){
        ...
        adapter = new StoryAdapter3 (list,getContext(),R.layout.activity_story_item3);
    ...
    private class Story1Async extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            ...
            if (null==o){
                Toast.makeText(StoryThirdFragment.super.getActivity(),"网络连接不可用，请稍后再试",Toast.LENGTH_SHORT).show();
            }else if (o.toString().equals("")){
                Toast.makeText(StoryThirdFragment.super.getActivity(),"暂无内容",Toast.LENGTH_SHORT).show();
            }else {
                list.clear();
